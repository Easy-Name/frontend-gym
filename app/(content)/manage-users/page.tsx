...
export default function CRUDPage() {
  ...
  useEffect(() => {
    const fetchUsers = async () => {
      try {
        ...
        const response = await axios.get("http://172.40.3.140:3005/users/me", {
  ...
  const handleCreate = async (e: React.FormEvent) => {
    ...
    try {
      ...
      const response = await axios.post(
        "http://172.40.3.140:3005/users/me",
        { ...formData },
        { headers: { Authorization: `Bearer ${token}` } }
      );
  ...
  const handleUpdate = async (e: React.FormEvent) => {
    ...
    try {
      ...
      await axios.patch(
        `http://172.40.3.140:3005/users/me/${selectedUserId}`,
        { ...formData },
        { headers: { Authorization: `Bearer ${token}` } }
      );
  ...
  const handleDelete = async () => {
    ...
    try {
      ...
      await axios.delete(`http://172.40.3.140:3005/users/me/${selectedUserId}`, {
        headers: { Authorization: `Bearer ${token}` },
      });
